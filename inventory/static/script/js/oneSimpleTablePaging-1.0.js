        ...
        'oneSimpleTablePagination': function(userConfigurations) {
            ...
            return this.each(function() {
                ...
                function resetCurrentPage(currPageNum) {
                    ...
                    $(table)[tblLocation]().find(cur_page).html(currPageNumber + '/' + totalPages);
                }
                ...
                function createPaginationElements() {
                    ...
                    paginationHTML += "</div>";
                    */
                    paginationHTML += '<ul id="tablePagination" class="pager">';
                    paginationHTML += '<li id="tablePagination_prevPage" class="previous"><a href="#">Previous</a></li>';
                    paginationHTML += '<li><span id="cur_page">1/' + totalPages + '</span></li>'
                    paginationHTML += '<li id="tablePagination_nextPage" class="next"><a href="#">Next</a></li>';
                    paginationHTML += '</ul>';
